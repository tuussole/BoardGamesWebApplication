...
namespace BoardGamesWebApplication.Controllers
{
    public class StatesController : Controller
    {
        ...
        public StatesController(DBBoardGamesContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.States != null ? 
                          ...
                          Problem("Entity set 'DBBoardGamesContext.States'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DBBoardGamesContext.States'  is null.");
            }
            var @state = await _context.States.FindAsync(id);
            if (@state != null)
            {
