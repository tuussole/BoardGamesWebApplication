...
namespace BoardGamesWebApplication.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public ItemsController(DBBoardGamesContext context)
        {
            _context = context;
        }
        ...
        {
            var isttp1Context = _context.Items.Include(i => i.Game).Include(i => i.Order);
        ...
        public async Task<IActionResult> Create([Bind("Id,Quantity,GameId,OrderId")] Item item)
        {
            ...
            ViewData["GameId"] = new SelectList(_context.Games, "Id", "Id", item.GameId);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DBBoardGamesContext.Items'  is null.");
            }
            var item = await _context.Items.FindAsync(id);
            if (item != null)
            {
